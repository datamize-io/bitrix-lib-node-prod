...
var Lead = /** @class */ (function (_super) {
    ...
    function Lead() {
        ...
        _this.prefixDefault = "crm.lead";
        return _this;
    }
    Lead.prototype.setContact = function (value) {
        if (!value) {
            return this;
        }
    ...
    Lead.prototype.setContacts = function (value) {
        if (!value) {
            return this;
        }
    ...
    Lead.prototype.setName = function (value) {
        if (!value) {
            return this;
        }
    ...
    Lead.prototype.setPipeline = function (value) {
        if (!value) {
            return this;
        }
        value = value.data ? value.data.ID : value;
    ...
    Lead.prototype.setStage = function (value) {
        var _a;
    ...
    Lead.prototype.setValue = function (value, currency) {
    ...
    Lead.prototype.setCurrency = function (value) {
    ...
    Lead.prototype.setStatus = function (value) {
    ...
    Lead.prototype.setOriginId = function (value) {
        if (!value) {
            return this;
        }
    ...
    Lead.prototype.setSource = function (value) {
        if (!value) {
            return this;
        }
        value = value.data ? value.data.ID : value;
    ...
    Lead.prototype.setTrack = function (utms) {
        if (!utms) {
            return this;
        }
    ...
    Lead.prototype.setField = function (field, value) {
        if (!value) {
            return this;
        }
    ...
    Lead.prototype.setUser = function (value) {
        if (!value) {
            return this;
        }
        value = value.data ? value.data.ID : value;
