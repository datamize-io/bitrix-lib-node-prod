...
import { EventInterface, EventBindInterface } from "../../interfaces/events/EventInterface.interface.js";
...
export class EventBindBuilder {
  ...
  build(): Record<string, any> {
    return this.payload as EventBindInterface;
  }
}

export abstract class EventBuilder extends BitrixBuilder implements EventInterface {
