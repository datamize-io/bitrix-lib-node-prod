 ...
 */
export class OpenLine extends OpenLineBuilder implements OpenLineInterface {
  /**
   ...
   */
  async add(configBuilder: OpenChannelConfigInterface) {
   ...
   */
  async delete(lineId: string | number) {
   ...
   */
  async get(lineId: string | number, displayQueue: "Y" | "N" = "Y", displayOfflineQueue: "Y" | "N" = "Y") {
